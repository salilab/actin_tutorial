...
print(IMP.atom.Selection(root_hier, molecule='actin', residue_index=61).get_selected_particles())
...
rex=IMP.pmi.macros.ReplicaExchange0(mdl,
        ...
        global_output_directory='output_topology/',      # The output directory for this sampling run.
